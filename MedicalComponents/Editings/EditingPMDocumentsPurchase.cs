...
{
    public partial class EditingPMDocumentsPurchase : Form
    {
        public int id = -1;
        public EditingPMDocumentsPurchase()
        {
            InitializeComponent();
        }
        public EditingPMDocumentsPurchase(int id)
        {
            this.id = id;
            InitializeComponent();
        }
        ...
        private void EditingPMDocumentsPurchase_Load(object sender, EventArgs e)
        {
            initComboBoxes();
        ...
        {
            ComboBoxWorker.initZIPMElement(comboBoxModelElement, 0);
        }
    }
}
